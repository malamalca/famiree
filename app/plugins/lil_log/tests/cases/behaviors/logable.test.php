...
class LogableBook extends CakeTestModel {
	...
	var $actsAs = array(
		'LilLog.LilLog' => array('userModel'=>'LogableUser'),
	);
	var $order = 'weight ASC';
	var $fixture = 'plugin.lil_log.book';
	var $useTable = 'books';
}
...
class Log extends CakeTestModel {
	...
	var $fixture = 'plugin.lil_log.log';
	var $useTable = 'logs';
...
class LogableUser extends CakeTestModel {
	...
	var $actsAs = array('LilLog.LilLog' => array('userModel'=>'LogableUser','ignore'=>array('counter')));
	var $fixture = 'plugin.lil_log.user';
	var $useTable = 'users';
}

class LogableComment extends CakeTestModel {
	var $name = 'LogableComment';
	var $actsAs = array('LilLog.LilLog' => array('userModel'=>'LogableUser'));
	var $fixture = 'plugin.lil_log.comment';
...
class LogableCase extends CakeTestCase {
    var $BookTest = NULL;
    var $Log = NULL;
	var $fixtures = array('plugin.lil_log.log', 'plugin.lil_log.book', 'plugin.lil_log.user', 'plugin.lil_log.comment');
	...
	function testConfigurationWithoutMost() {
		$this->LogableComment->Behaviors->attach('LilLog.LilLog',array('description_ids'=> false,'userModel'=>'LogableUser'));
